...
export const Soundscape = ({ className }) => {
  ...
  return (
      <button
        onClick={toggleSound}
        className={`bg-black/30 backdrop-blur-md text-white p-4 rounded-full border border-white/10 hover:bg-white/10 transition-colors ${className}`}
